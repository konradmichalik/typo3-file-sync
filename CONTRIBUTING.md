...
```bash
# Clone repository
git clone https://github.com/konradmichalik/typo3-file-sync.git
cd typo3-file-sync
...
3. Use descriptive commit messages following the conventional commits format: `<type>: <description>` (e.g. `feat: add S3 resource handler`, `fix: handle missing file metadata`).
